...
package dibasics.mandarcorreo_0_1;
 ...
 * @status
 */
public class mandarCorreo implements TalendJob {
	...
	private final String jobName = "mandarCorreo";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(mandarCorreo.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_DIBASICS_mandarCorreo = new byte[0];
		static byte[] commonByteArray_DIBASICS_mandarCorreo = new byte[0];

		public String dataset_fuente;

		public String getDataset_fuente() {
			return this.dataset_fuente;
		}

		public int series_cant;

		public int getSeries_cant() {
			return this.series_cant;
		}

		public int valores_cant;

		public int getValores_cant() {
			return this.valores_cant;
		}

		public String fecha_primer_valor;

		public String getFecha_primer_valor() {
			return this.fecha_primer_valor;
		}

		public String fecha_ultimo_valor;

		public String getFecha_ultimo_valor() {
			return this.fecha_ultimo_valor;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DIBASICS_mandarCorreo.length) {
					if (length < 1024 && commonByteArray_DIBASICS_mandarCorreo.length == 0) {
						commonByteArray_DIBASICS_mandarCorreo = new byte[1024];
					} else {
						commonByteArray_DIBASICS_mandarCorreo = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DIBASICS_mandarCorreo, 0, length);
				strReturn = new String(commonByteArray_DIBASICS_mandarCorreo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DIBASICS_mandarCorreo) {

				try {

					int length = 0;

					this.dataset_fuente = readString(dis);

					this.series_cant = dis.readInt();

					this.valores_cant = dis.readInt();

					this.fecha_primer_valor = readString(dis);

					this.fecha_ultimo_valor = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.dataset_fuente, dos);

				// int

				dos.writeInt(this.series_cant);

				// int

				dos.writeInt(this.valores_cant);

				// String

				writeString(this.fecha_primer_valor, dos);

				// String

				writeString(this.fecha_ultimo_valor, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("dataset_fuente=" + dataset_fuente);
			sb.append(",series_cant=" + String.valueOf(series_cant));
			sb.append(",valores_cant=" + String.valueOf(valores_cant));
			sb.append(",fecha_primer_valor=" + fecha_primer_valor);
			sb.append(",fecha_ultimo_valor=" + fecha_ultimo_valor);
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/Users/FamiliaNatelloMedina/Documents/UNLu/AYI ACADEMI/Módulo 6/SALIDA/dev/procesados/aportes.csv";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/Users/FamiliaNatelloMedina/Documents/UNLu/AYI ACADEMI/Módulo 6/SALIDA/dev/procesados/aportes.csv",
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.dataset_fuente = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.series_cant = ParserUtils.parseTo_int(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"series_cant", "row1", temp, ex_tFileInputDelimited_1),
								...
								rowstate_tFileInputDelimited_1.setException(new RuntimeException(
										"Value is empty for column : 'series_cant' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
							...
							if (temp.length() > 0) {
								...
								try {
									...
									row1.valores_cant = ParserUtils.parseTo_int(temp);

								} catch (java.lang.Exception ex_tFileInputDelimited_1) {
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											"Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
											"valores_cant", "row1", temp, ex_tFileInputDelimited_1),
											ex_tFileInputDelimited_1));
								}
								...
								rowstate_tFileInputDelimited_1.setException(new RuntimeException(
										"Value is empty for column : 'valores_cant' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));

							}

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.fecha_primer_valor = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 4;

							row1.fecha_ultimo_valor = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							String from_tSendMail_1 = ("cattaneogabriel@gmail.com");
							String to_tSendMail_1 = ("juanmannat@gmail.com").replace(";", ",");
							...
							try {
								...
								javax.mail.Session session_tSendMail_1 = javax.mail.Session
										.getInstance(props_tSendMail_1, new javax.mail.Authenticator() {
											protected javax.mail.PasswordAuthentication getPasswordAuthentication() {

												final String decryptedPassword_tSendMail_1 = routines.system.PasswordEncryptUtil
														.decryptPassword(
																"enc:routine.encryption.key.v1:EEyaSnBvLH0zFl/3YeVofIg9ezNmYw1PiIU6wGTXkf++3qS3WVZ7P2dwF7U=");

												return new javax.mail.PasswordAuthentication(
														"cattaneogabriel@gmail.com", decryptedPassword_tSendMail_1);
											}
										});
								...
								javax.mail.Message msg_tSendMail_1 = new javax.mail.internet.MimeMessage(
										session_tSendMail_1);
								msg_tSendMail_1
										.setFrom(new javax.mail.internet.InternetAddress(from_tSendMail_1, null));
									...
									if (file_tSendMail_1.isDirectory()) {
										...
										for (java.io.File subFile_tSendMail_1 : subFiles_tSendMail_1) {
											if (subFile_tSendMail_1.isFile()) {
												...
												mbpFile_tSendMail_1.setDataHandler(
														new javax.activation.DataHandler(fds_tSendMail_1));
												...
												if (contentTransferEncoding_tSendMail_1.get(i_tSendMail_1)
													...
													mbpFile_tSendMail_1.setHeader("Content-Transfer-Encoding",
															"base64");
												}
					...
					if (!((Object) ("C:/Users/FamiliaNatelloMedina/Documents/UNLu/AYI ACADEMI/Módulo 6/SALIDA/dev/procesados/aportes.csv") instanceof java.io.InputStream)) {
	...
	public static void main(String[] args) {
		final mandarCorreo mandarCorreoClass = new mandarCorreo();

		int exitCode = mandarCorreoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = mandarCorreo.class.getClassLoader()
					.getResourceAsStream("dibasics/mandarcorreo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = mandarCorreo.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : mandarCorreo");
		}
...
/************************************************************************************************
 * 43082 characters generated by Talend Open Studio for ESB on the 19 de febrero
 * de 2023, 00:34:46 ART
 ************************************************************************************************/