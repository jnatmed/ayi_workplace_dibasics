...
package dibasics.restcatalog_v1_1_0;
...
public class RESTCatalog_V1 implements TalendJob {
	...
	public void tXMLMap_9_TXMLMAP_OUT_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public void tXMLMap_9_TXMLMAP_IN_error(Exception exception, String errorComponent,
			final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		public javax.ws.rs.core.Response addMovie(
			...
			request_tRESTRequest_1.put("OPERATION", "addMovie");
	...
	public static class toDBStruct implements routines.system.IPersistableRow<toDBStruct> {
		final static byte[] commonByteArrayLock_DIBASICS_RESTCatalog_V1 = new byte[0];
		static byte[] commonByteArray_DIBASICS_RESTCatalog_V1 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(toDBStruct other) {
	...
	public static class addMovieStruct implements routines.system.IPersistableRow<addMovieStruct> {
		final static byte[] commonByteArrayLock_DIBASICS_RESTCatalog_V1 = new byte[0];
		static byte[] commonByteArray_DIBASICS_RESTCatalog_V1 = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(addMovieStruct other) {
	...
	public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				addMovieStruct addMovie = new addMovieStruct();
				addMovieStruct row7 = addMovie;
				toDBStruct toDB = new toDBStruct();
				toDBStruct row6 = toDB;
				...
				if (execStat) {
					runStat.updateStatOnConnection(iterateId, 0, 0, "displayMovies", "displayBooks", "displayMovie",
							"displayBook", "addMovie", "row7", "toDB", "row6", "row5", "response");
				}
...
// # Outputs initialization
					toDBStruct toDB_tmp = new toDBStruct();
					toDBStruct toDB_save = null;
//the aggregate variable
					toDBStruct toDB_aggregate = null;
...
// ###############################
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "addMovie");
					}
					...
					util_tLogRow_2.setTableName("entrada");
					util_tLogRow_2.addRow(new String[] { "body", });
...
///////////////////////    			
					...
					if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
						...
						java.util.Map<String, Object> params_tRESTRequest_1 = (java.util.Map<String, Object>) requestMessage_tRESTRequest_1
								.get("PARAMS");
						if (matchedFlow_tRESTRequest_1.equals("addMovie")) {
							addMovie = new addMovieStruct();
							...
							if (null != bodyObject_tRESTRequest_1) {
								...
								addMovie.body = body_tRESTRequest_1;
...
// build root xml tree 
						...
						final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:Q6kYAw/KZaP1i7h8rNUNFxEIzhrw7fpVuU2ILEOzamY3Ng==");
...
// build root xml tree 
						...
						final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:78igYoAMTxiXabNF0OLAsX3ZXrq8ht7EPxpo+fEk6yVxpQ==");
...
// build root xml tree 
						...
						final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:uyoatO1Q4Bqa5Cq19Yo08J1PLLeUDDRk6coqGxFkl90jHQ==");
...
// build root xml tree 
						...
						final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
								"enc:routine.encryption.key.v1:PnH5CvF1jl9axa8ZTrtqLcoXAjp6AsFU+zaDlr74oIMeJQ==");
...
// Start of branch "addMovie"
					if (addMovie != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection(iterateId, 1, 1, "addMovie");
						}
...
///////////////////////		
						...
						if (addMovie.body != null) { //
							row_tLogRow_2[0] = String.valueOf(addMovie.body);
...
///////////////////////    			
						...
						routines.system.DocumentToFlat docToFlat_tXMLMap_9_TXMLMAP_OUT = new routines.system.DocumentToFlat();
						docToFlat_tXMLMap_9_TXMLMAP_OUT.setOriginalLoop("/movie");
						docToFlat_tXMLMap_9_TXMLMAP_OUT.setIsOptional(false);
						if (row7.body == null || row7.body.getDocument() == null) {
							throw new RuntimeException("row7.body can't be empty");
						}
						org.dom4j.Document doc_tXMLMap_9_TXMLMAP_OUT = row7.body.getDocument();
						docToFlat_tXMLMap_9_TXMLMAP_OUT.setDoc(doc_tXMLMap_9_TXMLMAP_OUT);
						docToFlat_tXMLMap_9_TXMLMAP_OUT.setDefineNS(false);
						docToFlat_tXMLMap_9_TXMLMAP_OUT.setNamespaceTool(nsTool_tXMLMap_9_TXMLMAP_OUT);

						// old version, find NS from doc
						nsTool_tXMLMap_9_TXMLMAP_OUT.countNSMap(doc_tXMLMap_9_TXMLMAP_OUT.getRootElement());
						java.util.HashMap<String, String> xmlNameSpaceMap_tXMLMap_9_TXMLMAP_OUT = nsTool_tXMLMap_9_TXMLMAP_OUT.xmlNameSpaceMap;

						docToFlat_tXMLMap_9_TXMLMAP_OUT.setXmlNameSpaceMap(xmlNameSpaceMap_tXMLMap_9_TXMLMAP_OUT);

						String[] absolutePathMappings_tXMLMap_9_TXMLMAP_OUT = new String[7];
						String[] relativePathMappings_tXMLMap_9_TXMLMAP_OUT = new String[7];

						absolutePathMappings_tXMLMap_9_TXMLMAP_OUT[0] = "row7.body:/movie/releaseDate";
						relativePathMappings_tXMLMap_9_TXMLMAP_OUT[0] = "releaseDate";

						absolutePathMappings_tXMLMap_9_TXMLMAP_OUT[1] = "row7.body:/movie/price";
						relativePathMappings_tXMLMap_9_TXMLMAP_OUT[1] = "price";

						absolutePathMappings_tXMLMap_9_TXMLMAP_OUT[2] = "row7.body:/movie/@ASIN";
						relativePathMappings_tXMLMap_9_TXMLMAP_OUT[2] = "@ASIN";

						absolutePathMappings_tXMLMap_9_TXMLMAP_OUT[3] = "row7.body:/movie/title";
						relativePathMappings_tXMLMap_9_TXMLMAP_OUT[3] = "title";

						absolutePathMappings_tXMLMap_9_TXMLMAP_OUT[4] = "row7.body:/movie/director";
						relativePathMappings_tXMLMap_9_TXMLMAP_OUT[4] = "director";

						absolutePathMappings_tXMLMap_9_TXMLMAP_OUT[5] = "row7.body:/movie/runtime";
						relativePathMappings_tXMLMap_9_TXMLMAP_OUT[5] = "runtime";

						absolutePathMappings_tXMLMap_9_TXMLMAP_OUT[6] = "row7.body:/movie/studio";
						relativePathMappings_tXMLMap_9_TXMLMAP_OUT[6] = "studio";

						docToFlat_tXMLMap_9_TXMLMAP_OUT
								.setAbsolutePathMappings(absolutePathMappings_tXMLMap_9_TXMLMAP_OUT);
						docToFlat_tXMLMap_9_TXMLMAP_OUT
								.setCurrentRelativePathMappings(relativePathMappings_tXMLMap_9_TXMLMAP_OUT);
						// generate document to flat data
						docToFlat_tXMLMap_9_TXMLMAP_OUT.flat();
						// get flat data
						java.util.List<java.util.Map<String, String>> resultSet_tXMLMap_9_TXMLMAP_OUT = docToFlat_tXMLMap_9_TXMLMAP_OUT
								.getResultSet();

						for (java.util.Map<String, String> oneRow_tXMLMap_9_TXMLMAP_OUT : resultSet_tXMLMap_9_TXMLMAP_OUT) { // G_TXM_M_001
							...
							for (java.util.Map.Entry<String, String> entry_tXMLMap_9_TXMLMAP_OUT : oneRow_tXMLMap_9_TXMLMAP_OUT
									.entrySet()) {
								treeNodeAPI_tXMLMap_9_TXMLMAP_OUT.put(entry_tXMLMap_9_TXMLMAP_OUT.getKey(),
										entry_tXMLMap_9_TXMLMAP_OUT.getValue());
							}
...
// # Output table : 'toDB'
								...
								toDB_tmp = new toDBStruct();
								toDB_tmp.movieID = treeNodeAPI_tXMLMap_9_TXMLMAP_OUT
										.get_String("row7.body:/movie/@ASIN");
								toDB_tmp.title = treeNodeAPI_tXMLMap_9_TXMLMAP_OUT.get_String("row7.body:/movie/title");
								toDB_tmp.director = treeNodeAPI_tXMLMap_9_TXMLMAP_OUT
										.get_String("row7.body:/movie/director");
								toDB_tmp.releaseDate = treeNodeAPI_tXMLMap_9_TXMLMAP_OUT
										.get_String("row7.body:/movie/releaseDate");
								toDB_tmp.runtime = treeNodeAPI_tXMLMap_9_TXMLMAP_OUT
										.get_String("row7.body:/movie/runtime");
								toDB_tmp.studio = treeNodeAPI_tXMLMap_9_TXMLMAP_OUT
										.get_String("row7.body:/movie/studio");
								toDB_tmp.price = treeNodeAPI_tXMLMap_9_TXMLMAP_OUT.get_String("row7.body:/movie/price");
								allOutsForAggregate_tXMLMap_9.add(toDB_tmp);
...
///////////////////////    			
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "addMovie");
					}
...
//    	this.treeNodeAPI = treeNodeAPI;
						...
						// We generate the TreeNode_API object only if there is a document in the main
						// input table.
						void generateElements(boolean isInnerJoin, row5Struct row5, Var__tXMLMap_10__Struct Var) {
...
// build root xml tree 
							if (needRoot) {
								needRoot = false;
								org.dom4j.Element root = null;
								root = org.dom4j.DocumentHelper.createElement("message");
								doc.add(root);
								subTreeRootParent = root;
								valueMap.put("root", "Movie" + row5.movieID + " was inserted in the movie catalog");
					...
					String tableName_tDBOutput_2 = "movies";
					...
					if (dbProperties_tDBOutput_2 == null || dbProperties_tDBOutput_2.trim().length() == 0) {
						url_tDBOutput_2 = "jdbc:mysql://" + "localhost" + ":" + "3306" + "/" + "training" + "?"
					...
					final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:A1zGkPvSYZZr+uqreviHnifcQmmcH66vyp4nHdd6rmXnXg==");
					...
					String insert_tDBOutput_2 = "INSERT INTO `" + "movies"
							+ "` (`movieID`,`title`,`director`,`releaseDate`,`runtime`,`studio`,`price`) VALUES (?,?,?,?,?,?,?)";
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "toDB");
					}
					...
					util_tLogRow_1.setTableName("salida");
					util_tLogRow_1.addRow(new String[] { "movieID", "title", "director", "releaseDate", "runtime",
							"studio", "price", });
...
///////////////////////    			
					...
					java.util.List<Object> outs_tXMLMap_9 = (java.util.List<Object>) globalMap
							.get("allOutsForAggregate_tXMLMap_9");
					for (Object row_out_tXMLMap_9_TXMLMAP_IN : outs_tXMLMap_9) {// TD512
						...
						toDB = null;
						if (row_out_tXMLMap_9_TXMLMAP_IN != null
								&& row_out_tXMLMap_9_TXMLMAP_IN instanceof toDBStruct) {
							toDB = (toDBStruct) row_out_tXMLMap_9_TXMLMAP_IN;
						}
...
// Start of branch "toDB"
						if (toDB != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection(iterateId, 1, 1, "toDB");
							}
...
///////////////////////		
							...
							if (toDB.movieID != null) { //
								row_tLogRow_1[0] = String.valueOf(toDB.movieID);

							} //

							if (toDB.title != null) { //
								row_tLogRow_1[1] = String.valueOf(toDB.title);

							} //

							if (toDB.director != null) { //
								row_tLogRow_1[2] = String.valueOf(toDB.director);

							} //

							if (toDB.releaseDate != null) { //
								row_tLogRow_1[3] = String.valueOf(toDB.releaseDate);

							} //

							if (toDB.runtime != null) { //
								row_tLogRow_1[4] = String.valueOf(toDB.runtime);

							} //

							if (toDB.studio != null) { //
								row_tLogRow_1[5] = String.valueOf(toDB.studio);

							} //

							if (toDB.price != null) { //
								row_tLogRow_1[6] = String.valueOf(toDB.price);
...
///////////////////////    			
							...
							if (row6.movieID == null) {
								pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(1, row6.movieID);
							}

							if (row6.title == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, row6.title);
							}

							if (row6.director == null) {
								pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(3, row6.director);
							}

							if (row6.releaseDate == null) {
								pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(4, row6.releaseDate);
							}

							if (row6.runtime == null) {
								pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(5, row6.runtime);
							}

							if (row6.studio == null) {
								pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(6, row6.studio);
							}

							if (row6.price == null) {
								pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(7, row6.price);
							}
							...
							if (!whetherReject_tDBOutput_2) {
								row5 = new row5Struct();
								row5.movieID = row6.movieID;
								row5.title = row6.title;
								row5.director = row6.director;
								row5.releaseDate = row6.releaseDate;
								row5.runtime = row6.runtime;
								row5.studio = row6.studio;
								row5.price = row6.price;
							}
...
// Start of branch "row5"
							if (row5 != null) {
								...
								GenerateDocument_response gen_Doc_response_tXMLMap_10 = new GenerateDocument_response();
...
// # Output table : 'response'
									...
									gen_Doc_response_tXMLMap_10.generateElements(rejectedDocInnerJoin_tXMLMap_10, row5,
											Var);

									if (response_tmp.body == null) {
										response_tmp.body = new routines.system.Document();
										response_tmp.body.setDocument(gen_Doc_response_tXMLMap_10.getDocument());
									}
...
// ###############################
								...
								/**
								 * [tXMLMap_10 process_data_begin ] start
								 */

								currentComponent = "tXMLMap_10";

								/**
								 * [tXMLMap_10 process_data_begin ] stop
								 */
// Start of branch "response"
								if (response != null) {
									...
									if (execStat) {
										runStat.updateStatOnConnection(iterateId, 1, 1, "response");
									}
									...
									if (null == outputStream_tRESTResponse_5 && responseAlreadySent_tRESTResponse_5) {
										...
										if (null != response.body) {
											restProviderResponse_tRESTResponse_5 = response.body.getDocument();
										}
								...
								/**
								 * [tXMLMap_10 process_data_end ] start
								 */

								currentComponent = "tXMLMap_10";

								/**
								 * [tXMLMap_10 process_data_end ] stop
								 */
...
///////////////////////    			
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "toDB");
					}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = RESTCatalog_V1.class.getClassLoader()
					.getResourceAsStream("dibasics/restcatalog_v1_1_0/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 282045 characters generated by Talend Open Studio for ESB on the 25 de
 * febrero de 2023, 19:04:48 ART
 ************************************************************************************************/