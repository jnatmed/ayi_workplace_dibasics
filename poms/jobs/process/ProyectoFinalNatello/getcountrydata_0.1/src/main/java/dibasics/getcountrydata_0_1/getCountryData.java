...
package dibasics.getcountrydata_0_1;
...
/**
 * Job: getCountryData Purpose: informacion del pais para mapeo del padre
 * PetDirectory<br>
 * Description: con el IsoCode que me brinda el padre consulto a WSDL y obtengo
 * extraer {Name, CapitalCity y ContinentCode} en xml <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class getCountryData implements TalendJob, TalendESBJob {
	...
	private final String jobName = "getCountryData";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					getCountryData.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(getCountryData.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class respuestaCountryStruct implements routines.system.IPersistableRow<respuestaCountryStruct> {
		final static byte[] commonByteArrayLock_DIBASICS_getCountryData = new byte[0];
		static byte[] commonByteArray_DIBASICS_getCountryData = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DIBASICS_getCountryData.length) {
					if (length < 1024 && commonByteArray_DIBASICS_getCountryData.length == 0) {
						commonByteArray_DIBASICS_getCountryData = new byte[1024];
					} else {
						commonByteArray_DIBASICS_getCountryData = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DIBASICS_getCountryData, 0, length);
				strReturn = new String(commonByteArray_DIBASICS_getCountryData, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DIBASICS_getCountryData) {
				...
				try {
					...
					this.CapitalCity = readString(dis);

					this.ContinentCode = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.CapitalCity, dos);

				// String

				writeString(this.ContinentCode, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("Name=" + Name);
			sb.append(",CapitalCity=" + CapitalCity);
			sb.append(",ContinentCode=" + ContinentCode);
			sb.append("]");
		 ...
		 * Compare keys
		 */
		public int compareTo(respuestaCountryStruct other) {
	...
	public static class datosIsoCodeStruct implements routines.system.IPersistableRow<datosIsoCodeStruct> {
		final static byte[] commonByteArrayLock_DIBASICS_getCountryData = new byte[0];
		static byte[] commonByteArray_DIBASICS_getCountryData = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(datosIsoCodeStruct other) {
	...
	public void tFixedFlowInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				datosIsoCodeStruct datosIsoCode = new datosIsoCodeStruct();
				datosIsoCodeStruct row1 = datosIsoCode;
				respuestaStruct respuesta = new respuestaStruct();
				respuestaCountryStruct respuestaCountry = new respuestaCountryStruct();
...
// # Outputs initialization
				respuestaCountryStruct respuestaCountry_tmp = new respuestaCountryStruct();
				respuestaCountryStruct respuestaCountry_save = null;
//the aggregate variable
				respuestaCountryStruct respuestaCountry_aggregate = null;
...
// ###############################
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "datosIsoCode");
				}
...
// ###############################
// # Outputs initialization
				datosIsoCodeStruct datosIsoCode_tmp = new datosIsoCodeStruct();
				datosIsoCodeStruct datosIsoCode_save = null;
// ###############################
				int nb_line_tXMLMap_1 = 0;

				XML_API_tXMLMap_1 xml_api_tXMLMap_1 = new XML_API_tXMLMap_1();

				class GenerateDocument_datosIsoCode {
					...
					public GenerateDocument_datosIsoCode() {
...
// build root xml tree 
						if (needRoot) {
							...
							root = doc.addElement("tns:FullCountryInfo");
							subTreeRootParent = root;
							root.addNamespace("tns", TalendString
									.replaceSpecialCharForXML("http://www.oorsprong.org/websamples.countryinfo"));
							routines.system.DocumentHelper.applyNamespace2(root, "FullCountryInfo", "tns",
						...
						loop = org.dom4j.DocumentHelper.createElement("sCountryISOCode");
						if (subTreeRootParent.getNamespaceForPrefix("tns") != null) {
							loop.setQName(org.dom4j.DocumentHelper.createQName("sCountryISOCode",
									subTreeRootParent.getNamespaceForPrefix("tns")));
						}
						subTreeRootParent.elements().add(orderHelper.getInsertLocation(0, 0), loop);
						subTreeRootParent = loop;
						valueMap.put("loop", row2.iso);
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					GenerateDocument_datosIsoCode gen_Doc_datosIsoCode_tXMLMap_1 = new GenerateDocument_datosIsoCode();
					datosIsoCode_tmp.payload = null;
...
// # Output table : 'datosIsoCode'

						gen_Doc_datosIsoCode_tXMLMap_1.generateElements(rejectedDocInnerJoin_tXMLMap_1, row2, Var);

						if (datosIsoCode_tmp.payload == null) {
							datosIsoCode_tmp.payload = new routines.system.Document();
							datosIsoCode_tmp.payload.setDocument(gen_Doc_datosIsoCode_tXMLMap_1.getDocument());
						}

						datosIsoCode = datosIsoCode_tmp;
						datosIsoCode_save = datosIsoCode_tmp;
// ###############################
					 ...
					 */
// Start of branch "datosIsoCode"
					if (datosIsoCode != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection(iterateId, 1, 1, "datosIsoCode");
						}
...
///////////////////////		
						...
						if (datosIsoCode.payload != null) { //

							strBuffer_tLogRow_1.append(String.valueOf(datosIsoCode.payload));
...
///////////////////////    			
						...
						final javax.xml.namespace.QName serviceName_tESBConsumer_1 = new javax.xml.namespace.QName(
								"http://www.oorsprong.org/websamples.countryinfo", "CountryInfoService");
						final javax.xml.namespace.QName portName_tESBConsumer_1 = new javax.xml.namespace.QName(
								"http://www.oorsprong.org/websamples.countryinfo", "CountryInfoServiceSoap12");
						...
						try {
							routines.system.Document requestTalendDoc_tESBConsumer_1 = row1.payload;
							try {
									...
									ESBConsumer consumer_tESBConsumer_1 = registry
											.createConsumer(new ESBEndpointInfo() {
												...
												private java.util.Map<String, Object> props = new java.util.HashMap<String, Object>() {
													{
														...
														put("defaultOperationName", "FullCountryInfo");
														put("operationNamespace",
																"http://www.oorsprong.org/websamples.countryinfo");
														put("soapAction", "");
														if (null != getClass()
												...
												public String getEndpointUri() {
													...
													return "DIBASICS_getCountryData_tESBConsumer_1";
												}
								...
								respuesta.payload = responseTalendDoc_tESBConsumer_1;
...
// Start of branch "respuesta"
						if (respuesta != null) {
							...
							docToFlat_tXMLMap_2_TXMLMAP_OUT
									.setOriginalLoop("/tns:FullCountryInfoResponse/tns:FullCountryInfoResult");
							docToFlat_tXMLMap_2_TXMLMAP_OUT.setIsOptional(false);
							if (respuesta.payload == null || respuesta.payload.getDocument() == null) {
								throw new RuntimeException("respuesta.payload can't be empty");
							}
							org.dom4j.Document doc_tXMLMap_2_TXMLMAP_OUT = respuesta.payload.getDocument();
							...
							xmlNameSpaceMap_tXMLMap_2_TXMLMAP_OUT.put("tns",
									"http://www.oorsprong.org/websamples.countryinfo");
							...
							absolutePathMappings_tXMLMap_2_TXMLMAP_OUT[0] = "respuesta.payload:/tns:FullCountryInfoResponse/tns:FullCountryInfoResult/tns:Languages/tns:tLanguage/tns:sName";
							relativePathMappings_tXMLMap_2_TXMLMAP_OUT[0] = "tns:Languages/tns:tLanguage/tns:sName";

							absolutePathMappings_tXMLMap_2_TXMLMAP_OUT[1] = "respuesta.payload:/tns:FullCountryInfoResponse/tns:FullCountryInfoResult/tns:sContinentCode";
							relativePathMappings_tXMLMap_2_TXMLMAP_OUT[1] = "tns:sContinentCode";

							absolutePathMappings_tXMLMap_2_TXMLMAP_OUT[2] = "respuesta.payload:/tns:FullCountryInfoResponse/tns:FullCountryInfoResult/tns:sCapitalCity";
							relativePathMappings_tXMLMap_2_TXMLMAP_OUT[2] = "tns:sCapitalCity";
							...
							for (java.util.Map<String, String> oneRow_tXMLMap_2_TXMLMAP_OUT : resultSet_tXMLMap_2_TXMLMAP_OUT) { // G_TXM_M_001
								...
								{ // start of Var scope
									...
									respuestaCountry = null;

// # Output table : 'respuestaCountry'

									respuestaCountry_tmp = new respuestaCountryStruct();
									respuestaCountry_tmp.Name = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT.get_String(
											"respuesta.payload:/tns:FullCountryInfoResponse/tns:FullCountryInfoResult/tns:Languages/tns:tLanguage/tns:sName");
									respuestaCountry_tmp.CapitalCity = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT.get_String(
											"respuesta.payload:/tns:FullCountryInfoResponse/tns:FullCountryInfoResult/tns:sCapitalCity");
									respuestaCountry_tmp.ContinentCode = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT.get_String(
											"respuesta.payload:/tns:FullCountryInfoResponse/tns:FullCountryInfoResult/tns:sContinentCode");
									allOutsForAggregate_tXMLMap_2.add(respuestaCountry_tmp);
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "datosIsoCode");
				}
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "respuestaCountry");
				}
				...
				util_tLogRow_2.setTableName("SALIDA_XML_REQUEST");
				util_tLogRow_2.addRow(new String[] { "Name", "CapitalCity", "ContinentCode", });
...
///////////////////////    			
				...
				for (Object row_out_tXMLMap_2_TXMLMAP_IN : outs_tXMLMap_2) {// TD512
					...
					if (row_out_tXMLMap_2_TXMLMAP_IN != null
							&& row_out_tXMLMap_2_TXMLMAP_IN instanceof respuestaCountryStruct) {
						respuestaCountry = (respuestaCountryStruct) row_out_tXMLMap_2_TXMLMAP_IN;
					}
					 ...
					 */
// Start of branch "respuestaCountry"
					if (respuestaCountry != null) {
						...
						if (execStat) {
							runStat.updateStatOnConnection(iterateId, 1, 1, "respuestaCountry");
						}
...
///////////////////////		
						...
						if (respuestaCountry.Name != null) { //
							row_tLogRow_2[0] = String.valueOf(respuestaCountry.Name);

						} //

						if (respuestaCountry.CapitalCity != null) { //
							row_tLogRow_2[1] = String.valueOf(respuestaCountry.CapitalCity);

						} //

						if (respuestaCountry.ContinentCode != null) { //
							row_tLogRow_2[2] = String.valueOf(respuestaCountry.ContinentCode);
...
///////////////////////    			
					...
					} // End of branch "respuestaCountry"
...
///////////////////////    			
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "respuestaCountry");
				}
	...
	public static void main(String[] args) {
		final getCountryData getCountryDataClass = new getCountryData();

		int exitCode = getCountryDataClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = getCountryData.class.getClassLoader()
					.getResourceAsStream("dibasics/getcountrydata_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getCountryData.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : getCountryData");
		}
...
/************************************************************************************************
 * 105100 characters generated by Talend Open Studio for ESB on the 7 de marzo
 * de 2023, 18:50:12 ART
 ************************************************************************************************/